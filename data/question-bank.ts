...
const ethicsPlans: TopicPlan[] = [
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'ความซื่อสัตย์', points: ['การนำเสนอข้อมูลจริง', 'การไม่ปกปิดข้อยกเว้น'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'การบริการลูกค้า', points: ['การติดตามหลังการขาย', 'การอธิบายขั้นตอนเคลม'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'การรักษาความลับ', points: ['ข้อมูลสุขภาพลูกค้า', 'ข้อมูลการเงินผู้เอาประกันภัย'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'การเปิดเผยข้อมูล', points: ['การเปิดเผยผลประโยชน์', 'การอธิบายเงื่อนไขกรมธรรม์'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'ความเหมาะสมของแบบประกัน', points: ['การวิเคราะห์ความต้องการ', 'การไม่ขายเกินกำลังชำระ'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'จริยธรรมค่าบำเหน็จ', points: ['การไม่ชักจูงด้วยค่าตอบแทน', 'การไม่บิดเบือนเพื่อค่าคอมมิชชัน'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'การเปลี่ยนกรมธรรม์', points: ['การเปรียบเทียบข้อดีข้อเสีย', 'การป้องกันการ replacement ไม่เหมาะสม'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'ความประพฤติทางวิชาชีพ', points: ['การไม่ทำลายชื่อเสียงวิชาชีพ', 'การติดต่ออย่างสุภาพ'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'การเรียนรู้อย่างต่อเนื่อง', points: ['การติดตามกฎใหม่', 'การพัฒนาความรู้ผลิตภัณฑ์'] },
  { category: 'จรรยาบรรณและศีลธรรม', topic: 'มาตรฐานศีลธรรม', points: ['การไม่เอาเปรียบผู้เปราะบาง', 'การตัดสินใจโดยคำนึงถึงประโยชน์ลูกค้า'] },
];
...
const buildQuestion = (plan: TopicPlan, point: string, angle: Angle, sequence: number): Question => {
  ...
  return {
    id: `${plan.category === 'จรรยาบรรณและศีลธรรม' ? 'ETH' : 'LIFE'}-${String(sequence + 1).padStart(4, '0')}`,
    ...
    correctAnswer: diversified.answer,
    answer: diversified.answer,
    explanation: angle.explanation(plan.topic, point, plan.category),
    reference: `${plan.category}: ${plan.topic} / ${point}`,
    references: [`${plan.category}: ${plan.topic}`, `มุมคำถาม: ${angle.objective}`, `จุดความรู้: ${point}`],
    tags: [plan.category, plan.topic, point, angle.label, angle.objective],
    weight: angle.type === 'case-analysis' || angle.type === 'legal-interpretation' ? 1.25 : 1,
    estimatedTime: angle.scenario ? 60 : 35,
    sourceDocumentId: 'thai-life-agent-exam-source',
  };
};
...
export const questionBankQuality = {
  ...
  ethics: questionBank.filter((question) => question.category === 'จรรยาบรรณและศีลธรรม').length,
