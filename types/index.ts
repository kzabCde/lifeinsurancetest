...
export interface Question { id:string; category:Category; topic:string; subtopic:string; difficulty:Difficulty; type:QuestionType; question:string; choices:[string,string,string,string]; correctAnswer:number; answer:number; explanation:string; reference:string; references:string[]; tags:string[]; weight:number; estimatedTime:number; sourceDocumentId:string; }
